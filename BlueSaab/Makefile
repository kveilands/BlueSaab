...
OBJECTS += main.o
OBJECTS += common/system_clock.o
OBJECTS += common/SerialLog.o
OBJECTS += SaabCan.o
OBJECTS += common/Bluetooth.o
OBJECTS += common/RN52.o
OBJECTS += common/SerialRX.o
OBJECTS += Scroller.o
OBJECTS += Buttons.o
OBJECTS += CDCStatus.o
OBJECTS += MessageSender.o
OBJECTS += SidResource.o
OBJECTS += common/can_api.o
OBJECTS += utf_convert.o
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1502163838.06
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1502163838.06
